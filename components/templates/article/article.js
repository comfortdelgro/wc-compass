...
import '../contents/article.html'
import template from './article-demo.html'

export class CdgArticleDemo extends CdgDocumentComponent {
  content
  codeModal
  ...
  onInit() {
    ...
    iframe.setAttribute('src', './components/templates/contents/article.html')
  ...
  showCode() {
    ...
    downloadHTMLContent('./components/templates/contents/article.html').then(
      (result) => {
